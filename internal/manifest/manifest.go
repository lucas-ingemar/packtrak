...
// FIXME: Rename type to something that is not only conditional
var (
...
type ManifestFace interface {
	...
	Pm(name string) PmManifest
	AddConditional(oType ManifestObjectType, pmName string, cType ManifestConditionalType, cValue string, objects []string) error
	RemoveConditional(oType ManifestObjectType, pmName string, cType ManifestConditionalType, cValue string, objects []string) error
	AddGlobal(oType ManifestObjectType, pmName string, objects []string) error
	RemoveGlobal(oType ManifestObjectType, pmName string, objects []string) error

	AddToHost(toAdd []string, pmName string, oType ManifestObjectType) error
	AddToGroup(toAdd []string, group string, pmName string, oType ManifestObjectType) error
}
...
func (m *Manifest) AddConditional(oType ManifestObjectType, pmName string, cType ManifestConditionalType, cValue string, objects []string) error {
...
func (m *Manifest) RemoveConditional(oType ManifestObjectType, pmName string, cType ManifestConditionalType, cValue string, objects []string) error {
	c, err := m.getOrAddConditional(pmName, cType, cValue)
	if err != nil {
		return err
	}
...
func (m *Manifest) AddGlobal(oType ManifestObjectType, pmName string, objects []string) error {
	pm := m.pmPnt(pmName)
	switch oType {
	case TypePackage:
...
func (m *Manifest) RemoveGlobal(oType ManifestObjectType, pmName string, objects []string) error {
	pm := m.pmPnt(pmName)
	switch oType {
	case TypePackage:
...
func (m *Manifest) AddToHost(toAdd []string, pmName string, oType ManifestObjectType) error {
...
func (m *Manifest) AddToGroup(toAdd []string, group string, pmName string, oType ManifestObjectType) error {
	return m.AddConditional(oType, pmName, MConditionGroup, group, toAdd)
}

func (m *Manifest) getOrAddConditional(pmName string, cType ManifestConditionalType, cValue string) (*Conditional, error) {
	pm := m.pmPnt(pmName)
...
func (m *Manifest) pmPnt(name string) *PmManifest {
	switch name {
	case "dnf":
		return &m.Dnf
	case "go":
